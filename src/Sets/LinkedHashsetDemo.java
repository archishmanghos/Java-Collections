...
public class LinkedHashsetDemo {
    public static void main(String[] args) {
        ...
        Set<Integer> set1 = new LinkedHashSet<>(li1);
        System.out.print("[ ");
        ...
        Set<Integer> set3 = new LinkedHashSet<>(li1);
        System.out.print("[ ");
        ...
        // union of 2 sets
        Set<Integer> set4 = new LinkedHashSet<>(li1);
        System.out.print("[ ");
        ...
        // contains
        Set<Integer> set5 = new LinkedHashSet<>(li1);
        System.out.print("[ ");
        ...
        Set<StudentMarks> set6 = new LinkedHashSet<>();
